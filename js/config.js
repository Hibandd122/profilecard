...
const CONFIG = {
    ...
    music: {
        playlist: [
            ...
            { name: "うれしい！たのしい！大好き！", file: "assets/song2.mp3" },
            { name: "Remember", file: "assets/song3.mp3" },
            { name: "ハッピーシンセサイザ", file: "assets/song4.mp3" },
            { name: "World is Mine CPK!", file: "assets/song5.mp3" }
        ],
        defaultVolume: 45,
        enablePulse: true
    },
